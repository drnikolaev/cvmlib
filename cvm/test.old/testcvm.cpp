...
//        CheckBool    (rv1 == rv2,  true,  "srmatrix svd", os, __LINE__);
        ...
        CheckReal (std::abs(U(CVM0, CVM0)), std::abs((treal)-0.38047558632), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0, CVM0+1)), std::abs((treal)-0.11967099264), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0, CVM0+2)), std::abs((treal)-0.43908282438), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0, CVM0+3)), std::abs((treal)0.56539958591), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0, CVM0+4)), std::abs((treal)0.024311516146),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0, CVM0+5)), std::abs((treal)-0.5725868611), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+1, CVM0)), std::abs((treal)-0.40375371317), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+1, CVM0+1)), std::abs((treal)-0.34511083711), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+1, CVM0+2)), std::abs((treal)0.05657618529),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+1, CVM0+3)), std::abs((treal)-0.21477557652), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+1, CVM0+4)), std::abs((treal)0.80890058873),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+1, CVM0+5)), std::abs((treal)0.11929741721),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+2, CVM0)), std::abs((treal)-0.54512048625), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+2, CVM0+1)), std::abs((treal)-0.42926489349), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+2, CVM0+2)), std::abs((treal)-0.051392692809), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+2, CVM0+3)), std::abs((treal)-0.43214416281), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+2, CVM0+4)), std::abs((treal)-0.57232764817), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+2, CVM0+5)), std::abs((treal)0.040330924871),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+3, CVM0)), std::abs((treal)-0.264784294), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+3, CVM0+1)), std::abs((treal)0.068319525327),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+3, CVM0+2)), std::abs((treal)0.88386086743),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+3, CVM0+3)), std::abs((treal)0.21525369818),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+3, CVM0+4)), std::abs((treal)-0.06252092259), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+3, CVM0+5)), std::abs((treal)-0.30621669907), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+4, CVM0)), std::abs((treal)-0.4463101123), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+4, CVM0+1)), std::abs((treal)0.81682762328),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+4, CVM0+2)), std::abs((treal)-0.14189967506), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+4, CVM0+3)), std::abs((treal)-0.32126958427), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+4, CVM0+4)), std::abs((treal)0.062133782096),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+4, CVM0+5)), std::abs((treal)-0.079935268), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+5, CVM0)), std::abs((treal)-0.35462865661), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+5, CVM0+1)), std::abs((treal)0.10214739916),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+5, CVM0+2)), std::abs((treal)0.0043184439799),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+5, CVM0+3)), std::abs((treal)0.54580022185),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+5, CVM0+4)), std::abs((treal)-0.098794626562), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs(U(CVM0+5, CVM0+5)), std::abs((treal)0.74573957611),"rmatrix svd", os, __LINE__, dVeryPessimisticSp);

        CheckReal (std::abs((~V)(CVM0, CVM0)), std::abs((treal)-4.442941288423535e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+1, CVM0)), std::abs((treal)-5.580672381903871e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+2, CVM0)), std::abs((treal)-3.243861032062802e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+3, CVM0)), std::abs((treal)-6.212385538433783e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0, CVM0+1)), std::abs((treal)5.555312577999473e-001), "rmatrix svd", os, __LINE__, dVeryPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+1, CVM0+1)), std::abs((treal)-6.542987401123238e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+2, CVM0+1)), std::abs((treal)-3.513606455925113e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+3, CVM0+1)), std::abs((treal)3.739303103834293e-001),"rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0, CVM0+2)), std::abs((treal)-4.353789666739416e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+1, CVM0+2)), std::abs((treal)2.774569004588126e-001),"rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+2, CVM0+2)), std::abs((treal)-7.320995334295977e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+3, CVM0+2)), std::abs((treal)4.444019542237462e-001),"rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0, CVM0+3)), std::abs((treal)-5.517543874418699e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+1, CVM0+3)), std::abs((treal)-4.283360651798634e-001), "rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+2, CVM0+3)), std::abs((treal)4.851284633245337e-001),"rmatrix svd", os, __LINE__, dPessimisticSp);
        CheckReal (std::abs((~V)(CVM0+3, CVM0+3)), std::abs((treal)5.260662365874236e-001),"rmatrix svd", os, __LINE__, dPessimisticSp);
