...
\verb"    explicit "\GOT{cvector}{cvector.cvector (int)}\verb" (int size);"\\
\verb"    "\GOT{cvector}{cvector (std::initializerlist)}\verb" (std::initializer_list<TC> list);"\\
\verb"    "\GOT{cvector}{cvector.cvector (int, TC)}\verb" (int size, TC c);"\\
\verb"    "\GOT{cvector}{cvector.cvector (TC*,int,int)}\verb" (TC* pD, int size, int incr = 1);"\\
\verb"    "\GOT{cvector}{cvector.cvector (const TC*,int,int)}\verb" (const TC* pD, int size, int incr = 1);"\\
\verb"    "\GOT{cvector}{cvector.cvector (const cvector&)}\verb" (const cvector& v);"\\
\verb"    "\GOT{cvector}{cvector.cvector (TR*,TR*,int,int,int)}\verb" (const TR* pRe, const TR* pIm, int size,"\\
...
\verb"    "\GOT{cvector}{cvector.cvector (const TR*,int,bool,int)}\verb" (const TR* pA, int size,"\\
...
\verb"    cvector& "\GOT{assign}{cvector.assign (const TC*, int)}\verb" (const TC* p, int incr = 1);"\\
\verb"    cvector& "\GOT{assign}{cvector.assign (int, const TC*, int)}\verb" (int n, const TC* p, int incr = 1);"\\
\verb"    cvector& "\GOT{assign}{cvector.assign (int, const TC*, int, int)}\verb" (int n, const TC* p, int size, tint incr);"\\
...
\verb"    cvector& "\GOT{resize}{cvector.resize}\verb" (int new_size) throw (cvmexception);"\\
