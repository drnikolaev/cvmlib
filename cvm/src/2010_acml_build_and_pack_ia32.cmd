...
devenv src_acml_2010.vcxproj /%BUILDCMD% "Debug|Win32"
	IF ERRORLEVEL 1 GOTO ErrMsg
devenv src_acml_2010.vcxproj /%BUILDCMD% "Release|Win32"
	IF ERRORLEVEL 1 GOTO ErrMsg
pushd ..\test
...
copy %MSREDIST%\msvcp100.dll acml32
copy %MSREDIST%\msvcr100.dll acml32
SET PATH=.;acml32
...
devenv src_acml_mp_2010.vcxproj /%BUILDCMD% "Debug|Win32"
	IF ERRORLEVEL 1 GOTO ErrMsg
devenv src_acml_mp_2010.vcxproj /%BUILDCMD% "Release|Win32"
	IF ERRORLEVEL 1 GOTO ErrMsg
pushd ..\test
call 2010_build_test_ia32.cmd %BUILDCMD%
	IF ERRORLEVEL 1 GOTO ErrMsg
...
copy %MSREDIST%\msvcp100.dll acml_mp32
copy %MSREDIST%\msvcr100.dll acml_mp32
SET PATH=.;acml_mp32
regtest_cvm_ia32 -t3 -r3
IF ERRORLEVEL 1 GOTO ErrMsg
SET PATH=%PATHORIG%
