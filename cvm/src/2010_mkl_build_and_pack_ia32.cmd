...
SET MKLREDIST="C:\Program Files (x86)\Intel\Composer XE 2013\redist\ia32\mkl"
...
devenv src_mkl_2010.vcxproj /%BUILDCMD% "Debug|Win32"
	IF ERRORLEVEL 1 GOTO ErrMsg
devenv src_mkl_2010.vcxproj /%BUILDCMD% "Release|Win32"
	IF ERRORLEVEL 1 GOTO ErrMsg
pushd ..\test
