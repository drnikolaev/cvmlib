...
SET MKLREDIST="C:\Program Files (x86)\Intel\Composer XE 2013\redist\intel64\mkl"
...
copy %MKLREDIST%\mkl_cdft_core.dll %DEST%
...
devenv src_mkl_2010.vcxproj /%BUILDCMD% "Debug|x64"
	IF ERRORLEVEL 1 GOTO ErrMsg
devenv src_mkl_2010.vcxproj /%BUILDCMD% "Release|x64"
	IF ERRORLEVEL 1 GOTO ErrMsg
pushd ..\test
...
devenv src_mkl_ilp64_2010.vcxproj /%BUILDCMD% "Debug|x64"
	IF ERRORLEVEL 1 GOTO ErrMsg
devenv src_mkl_ilp64_2010.vcxproj /%BUILDCMD% "Release|x64"
	IF ERRORLEVEL 1 GOTO ErrMsg
pushd ..\test
