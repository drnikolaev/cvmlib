...
//        EXPECT_TRUE(rv1 == rv2) << "srmatrix svd";
    ...
    EXPECT_NEAR(std::abs(-0.38047558632),std::abs(U(CVM0, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.11967099264),std::abs(U(CVM0, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.43908282438),std::abs(U(CVM0, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.56539958591),std::abs(U(CVM0, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.024311516146),std::abs(U(CVM0, CVM0+4)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.5725868611),std::abs(U(CVM0, CVM0+5)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.40375371317),std::abs(U(CVM0+1, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.34511083711),std::abs(U(CVM0+1, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.05657618529),std::abs(U(CVM0+1, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.21477557652),std::abs(U(CVM0+1, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.80890058873),std::abs(U(CVM0+1, CVM0+4)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.11929741721),std::abs(U(CVM0+1, CVM0+5)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.54512048625),std::abs(U(CVM0+2, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.42926489349),std::abs(U(CVM0+2, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.051392692809),std::abs(U(CVM0+2, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.43214416281),std::abs(U(CVM0+2, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.57232764817),std::abs(U(CVM0+2, CVM0+4)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.040330924871),std::abs(U(CVM0+2, CVM0+5)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.264784294),std::abs(U(CVM0+3, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.068319525327),std::abs(U(CVM0+3, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.88386086743),std::abs(U(CVM0+3, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.21525369818),std::abs(U(CVM0+3, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.06252092259),std::abs(U(CVM0+3, CVM0+4)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.30621669907),std::abs(U(CVM0+3, CVM0+5)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.4463101123),std::abs(U(CVM0+4, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.81682762328),std::abs(U(CVM0+4, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.14189967506),std::abs(U(CVM0+4, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.32126958427),std::abs(U(CVM0+4, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.062133782096),std::abs(U(CVM0+4, CVM0+4)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.079935268),std::abs(U(CVM0+4, CVM0+5)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.35462865661),std::abs(U(CVM0+5, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.10214739916),std::abs(U(CVM0+5, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.0043184439799),std::abs(U(CVM0+5, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.54580022185),std::abs(U(CVM0+5, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-0.098794626562),std::abs(U(CVM0+5, CVM0+4)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(0.74573957611),std::abs(U(CVM0+5, CVM0+5)),sp<TP>()) << "rmatrix svd";

    EXPECT_NEAR(std::abs(-4.442941288423535e-001),std::abs((~V)(CVM0, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-5.580672381903871e-001),std::abs((~V)(CVM0+1, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-3.243861032062802e-001),std::abs((~V)(CVM0+2, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-6.212385538433783e-001),std::abs((~V)(CVM0+3, CVM0)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(5.555312577999473e-001),std::abs((~V)(CVM0, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-6.542987401123238e-001),std::abs((~V)(CVM0+1, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-3.513606455925113e-001),std::abs((~V)(CVM0+2, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(3.739303103834293e-001),std::abs((~V)(CVM0+3, CVM0+1)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-4.353789666739416e-001),std::abs((~V)(CVM0, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(2.774569004588126e-001),std::abs((~V)(CVM0+1, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-7.320995334295977e-001),std::abs((~V)(CVM0+2, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(4.444019542237462e-001),std::abs((~V)(CVM0+3, CVM0+2)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-5.517543874418699e-001),std::abs((~V)(CVM0, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(-4.283360651798634e-001),std::abs((~V)(CVM0+1, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(4.851284633245337e-001),std::abs((~V)(CVM0+2, CVM0+3)),sp<TP>()) << "rmatrix svd";
    EXPECT_NEAR(std::abs(5.260662365874236e-001),std::abs((~V)(CVM0+3, CVM0+3)),sp<TP>()) << "rmatrix svd";
